...
with tf.Session() as sess:
    ...
    while True:
        ...
        if sess.run(y, feed_dict={x: frame})[0] == 1.:
            print("el valor es 0")
        elif sess.run(y, feed_dict={x: frame})[1] == 1.:
            print("el valor es 1")
        elif sess.run(y, feed_dict={x: frame})[2] == 1.:
            print("el valor es 2")
        elif sess.run(y, feed_dict={x: frame})[3] == 1.:
            print("el valor es 3")
        elif sess.run(y, feed_dict={x: frame})[4] == 1.:
            print("el valor es 4")
        elif sess.run(y, feed_dict={x: frame})[5] == 1.:
            print("el valor es 5")
        elif sess.run(y, feed_dict={x: frame})[6] == 1.:
            print("el valor es 6")
        elif sess.run(y, feed_dict={x: frame})[7] == 1.:
            print("el valor es 7")
        elif sess.run(y, feed_dict={x: frame})[8] == 1.:
            print("el valor es 8")
        elif sess.run(y, feed_dict={x: frame})[9] == 1.:
            print("el valor es 9")
